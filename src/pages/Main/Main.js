        ...
        <header>
          ...
          <nav>
            <ul className="list-nav">
              ...
              <li>
                <img
                  src={`${process.env.PUBLIC_URL}/images/icon/send.png`}
                  alt="다이렉트 메시지 아이콘"
                />
              </li>
              <li>
              ...
              <li>
                <img
                  src={`${process.env.PUBLIC_URL}/images/icon/compass.png`}
                  alt="탐색 아이콘"
                />
              </li>
              <li>
                <img
                  src={`${process.env.PUBLIC_URL}/images/icon/heart.png`}
                  alt="좋아요 아이콘"
                />
              </li>
              <li className="list-profile">
                ...
                <div className="wrap-menu">
                  ...
                  <div className="menu-change">
                    <img
                      src={`${process.env.PUBLIC_URL}/images/icon/change.png`}
                      alt="프로필 아이콘"
                    />
                    <p>계정 전환</p>
                  </div>
          ...
          <div>
            <div className="box-story">
              ...
              <li>
                <img
                  className="img-profile-56px img-story"
                  src={`${process.env.PUBLIC_URL}/images/profile_peach.jpg`}
                  alt="프로필 이미지"
                />
            ...
            <div>
              <article className="box-feed">
                <div className="head-feed">
                  ...
                  <img
                    className="icon-more"
                    src={`${process.env.PUBLIC_URL}/images/icon/more.png`}
                    alt="더보기 아이콘"
                  />
                </div>
                ...
                <img
                  className="img-feed"
                  src={`${process.env.PUBLIC_URL}/images/feed_apple.jpg`}
                  alt="피드 이미지"
                />
                ...
                <div className="box-chat">
                  <img
                    className="img-icon"
                    src={`${process.env.PUBLIC_URL}/images/icon/smile.png`}
                    alt="이모지 아이콘"
                  />
                  <form>
                    <input
            ...
            <div className="box-recommend">
              ...
              <div className="box-recommend-profile">
                <div className="profile-recommend">
                  <img
                    className="img-profile-32px"
                    src={`${process.env.PUBLIC_URL}/images/profile_watermelon.jpg`}
                    alt="프로필 이미지"
                  />
                  <div>
